...
function patch_prerm_on_linux_image_file() {
    ...
    local stringReplaceWith="print STDERR \"TWON-16900: Migrating to unified kernel, so proceeding with removing running kernel image.\"; #TWON-16900 exit 1;    #Operation not permitted"
